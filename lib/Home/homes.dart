...
class _HomesState extends State<Homes> with SingleTickerProviderStateMixin {
  ...
  changeSelected(int i) {
    setState(() {
      ...
      _tabController.animateTo(i, duration: const Duration(milliseconds: 100));
    });
  }
  ...
  getData() async {
    ...
    _tabController =
        TabController(length: allData['categories'].length - 1, vsync: this);
    setState(() {
      isHide = false;
    });
  }
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      mainText(
                                          ...
                                          1,
                                          "mons"),
                                      mainText("Welcome Back!", Colors.black,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Row(
                                          ...
                                          //   })
                                          // ],
                                          children: allData['banners']
                                              .asMap()
                                              .entries
                                              .map<Widget>((entry) {
                                            return GestureDetector(
                                              onTap: () => _onDotTap(entry
                                                  .key), // Optional: Allow tap to change page
                                              child: Container(
                                                width: 8.0,
                                                height: 8.0,
...
class tabBarItem extends StatelessWidget {
  ...
  tabBarItem(
      this.callback, this.data, this.main, this.text, this.r, this.isSelected, {super.key});
    ...
    return (isSelected)
        ? AnimatedContainer(
            ...
            padding: EdgeInsets.only(
                right: isSelected ? 0.0 : 0), // Adjust padding smoothly
            child: Container(
              decoration: BoxDecoration(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: Colors
                      .transparent, // Important to make button background transparent
                    ...
                    children: [
                      Padding(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Padding(
                            ...
                            child: Image.network(
                                thumbnailUrl + data['category_image']),
                          ),
                        ),
                      ),
                      AnimatedContainer(
                      ...
                      if (isSelected)
                        AnimatedOpacity(
                          ...
                          duration: const Duration(milliseconds: 300),
                          child: onlymainText(data['category_name'], text, 12.0,
                              FontWeight.normal, 1, "mons"),
                        ),
                    ],
                  ),
                ),
      ...
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: CachedNetworkImageProvider(
                "$imageUrl/thumbs/" + data['banner_image']),
            fit: BoxFit.contain,
          )
