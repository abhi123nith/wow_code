        ...
        child: Stack(
          children: [
            IntroductionScreen(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                mainText(
                                    "lorem lipsum lorem lipsu lore m ererl lorem lipsum lorem  lorem lipsum lorem loreor",
                                    Colors.grey,
                                    15.0,
                                    FontWeight.normal,
                                    2,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(
                                    ...
                                    width: MediaQuery.of(context).size.width *
                                        0.50,
                                    child: custombtnsss("Let's Start", () {},
                                        Colors.black, Colors.white, 30.0))
                              ],
                            ),
                          ),
              ...
              controlsPosition:
                  const Position(left: 0, right: 0, top: 0.0, bottom: 0),
              dotsFlex: 1,
              skipOrBackFlex: 1,
              nextFlex: 1,
              ...
              overrideNext: Row(
                children: [
                  const Spacer(),
                  onlymainText("Skip", Colors.grey, 10.0, FontWeight.normal,
                      1, "mons"),
                  const SizedBox(
                    width: 20.0,
                  ),
