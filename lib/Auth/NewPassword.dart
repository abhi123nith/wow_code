    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          SafeArea(
            child: Padding(
              padding: (MediaQuery.of(context).size.width < 900)?const EdgeInsets.symmetric(horizontal: 25.0,vertical: 25.0):const EdgeInsets.symmetric(horizontal: 300.0,vertical: 25.0),
              child: Form(
                key: formKey,
                child: Column(
                  ...
                  children: [
                    ...
                    TextFieldPin(
                        ...
                        textStyle: const TextStyle(fontSize: 20,fontFamily: 'mons',color: Colors.white),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          }, icon: const Icon(Iconsax.eye,color: Colors.grey,)):
                    ...
                    Row(
                      children: [
                        ...
                        FloatingActionButton(onPressed: (){
                          ...
                          backgroundColor: Colors.white, child: const Icon(Icons.arrow_forward_sharp, color: Colors.black,),)
                      ],
                    ),
