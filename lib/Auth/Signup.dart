                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                              ...
                              child: mainTextLeft(
                                  (refferalCode.isEmpty) ? "Enter" : "Change",
                                  Colors.white,
                                  15.0,
                                  FontWeight.normal,
                                  1,
                      ...
                      (refferalCode.isNotEmpty)
                          ? mainTextLeft(refferalCode, Colors.grey, 10.0,
                      ...
                      Row(
                        children: [
                          mainTextLeft("Sign Up", Colors.white, 25.0,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Spacer(),
                            mainText("Already have an account?", Colors.grey,
                                13.0, FontWeight.bold, 1, "mons"),
                            TextButton(
                              onPressed: () {
                                navScreen(const Login(), context, false);
                              },
                              child: mainText("Sign-in", Colors.white, 13.0,
                                  FontWeight.bold, 1, "mons"),
                            ),
                            const Spacer(),
                          ],
    ...
    return (await showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            contentTextStyle: const TextStyle(
                fontFamily: 'mons', fontSize: 13.0, color: Colors.grey),
